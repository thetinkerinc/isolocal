...
class Local {
	...
	constructor(cookieJar?: SvelteKitCookies, defaults?: Record<string, unknown>) {
...
function makeLocalStorage(cookieJar?: SvelteKitCookies, defaults?: Record<string, unknown>) {
